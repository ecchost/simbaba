          ...
          <div class="row-fluid">
                ...
                <div class="widget red">
                    <div class="widget-title">
                        <h4><i class="icon-plus"></i> Input Jalan, Irigasi Dan Jaringan</h4>
                    </div>
                <form action="<?php echo site_url('Input/Tambah04');?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <div class="row">
                          ...
                          <div class="span8">
                              <div class="controls">
                                  <input type="text" autocomplete="off"  class="span8" style="width:470px;" name="konstruksi">
                              </div>
                          </div>
                      </div>
                      <div class="row">
                          ...
                          <div class="span8">
                              <div class="controls">
                                <div class="input-append">
                                  <input type="text" autocomplete="off" onkeypress='return isNumberKeyTrue(event)' style="width:440px" class="span10" name="panjang"><span class="add-on">Km</span>
                                </div>
                              </div>  
                          </div>
                      </div>
                      <div class="row">
                          ...
                          <div class="span8">
                              <div class="controls">
                                <div class="input-append">
                                  <input type="text" autocomplete="off" onkeypress='return isNumberKeyTrue(event)' style="width:440px" class="span10" name="lebar"><span class="add-on">M</span>
                                </div>
                              </div>  
                          </div>
                      </div>
