          ...
          <div class="row-fluid">
                ...
                <div class="widget red">
                    <div class="widget-title">
                        <h4><i class="icon-home"></i> Edit Gedung Dan Bangunan</h4>
                    </div>
                <form action="<?php echo site_url('Gedung_bangunan/update');?>" method="post" enctype="multipart/form-data">
                    <div class="widget-body">
                    <input type="hidden" name="id_barang" value="<?php echo $getrow['id_bangunan']; ?>">
                    <input type="hidden" name="scan_foto_lama" value="<?php echo $getrow['foto']; ?>">
                    <div class="row">
                      ...
                      <div class="row">
                          ...
                          <div class="span1">
                              <div class="controls">
                              	 <input type="radio" name="tingkat" <?php if($getrow['tingkat']==1){echo "checked";} ?> value="1" > Ya
                              </div>  
                          </div>
                          <div class="span2">
                              <div class="controls">
                      ...
                      <div class="row">
                          ...
                          <div class="span2">
                              <div class="controls">
                                 <input type="radio" name="beton" value="0" <?php if($getrow['beton']==0){echo "checked";} ?>> Tidak
                              </div>  
                          </div>
                      </div>
                      <div class="row">
                          ...
                          <div class="span8">
                              <div class="controls">
                                <div class="input-append">
                                  <input type="text" autocomplete="off" value="<?php echo $getrow['luas_lantai']; ?>" onkeypress='return isNumberKeyTrue(event)' style="width:440px" class="span10" name="luas"><span class="add-on">M2</span>
                                </div>
                              </div>  
                          </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="span8">
                              <div class="controls">
                                <div class="input-append">
                                  <input type="text" autocomplete="off" onkeypress='return isNumberKeyTrue(event)' value="<?php echo $getrow['luas']; ?>" style="width:440px" class="span10" name="luas_tanah"><span class="add-on">M2</span>
                                </div>
                              </div>  
                          </div>
                      </div>
