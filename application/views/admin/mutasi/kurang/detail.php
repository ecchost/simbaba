<div id="main-content">
          ...
          <div class="row-fluid">
                ...
                <div class="widget red">
                    <div class="widget-title">
                        <h4><i class="icon-book"></i> Detail Sub Bidang Di Bidang <i><strong>"<?php echo $namabidang['nama_bidang']; ?>"</strong></i></h4>
                    </div>
 ...
 <div id="myModal1" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-header">
        ...
        <h4 id="myModalLabel1">Tambah Sub Bidang Bidang <i><strong>"<?php echo $namabidang['nama_bidang']; ?>"</strong></i></h4>
    </div>
      ...
      <div class="modal-body">
          <div class="control-group">
              <div class="row">
                   ...
                   <label class="span3">ID Sub Bidang</label>
                  <div class="span8">
                      <div class="controls">
               ...
               <div class="row">
                   <label class="span1"></label>
                   <label class="span3">Nama Sub Bidang</label>
                  <div class="span8">
                      <div class="controls">
...
<div id="myModal1<?php echo $rows->id_subbid;?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h4 id="myModalLabel1">Edit Sub Bidang <strong>{<?php echo $row->nama_subbid; ?>}</strong> Bidang <i><strong>"<?php echo $namabidang['nama_bidang']; ?>"</strong></i></h4>
    </div>
      ...
      <div class="modal-body">
          <div class="control-group">
              <div class="row">
                  ...
                  <div class="span8">
                      <div class="controls">
                          <input type="text" value="<?php echo $row->id_subbid; ?>" readonly required class="span12" name="id_subbidang">
                      </div>  
                  </div>
              </div>
               <div class="row">
                  ...
                  <div class="span8">
                      <div class="controls">
                          <input  autofocus type="text" value="<?php echo $row->nama_subbid; ?>" autocomplete="off" required class="span12" name="nama_subbidang">
                      </div>  
                  </div>
              </div>
               <div class="row">
                 <label class="span1"></label>
                 <label class="span3">Bidang</label>
                <div class="span8">
                    <div class="controls">
                        <select required class="span6 chzn-select" name="bidang" style="width:470px;" data-placeholder="Pilih Pangkat" tabindex="1">
