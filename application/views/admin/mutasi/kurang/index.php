<div id="main-content">
                    ...
                    <div class="widget-body">
                        <table class="table table-striped table-bordered" id="sample_1">
                            ...
                            <tr>
                                ...
                                <th >Jumlah Sub Pembibidang Barang</th>
                                <th >Status</th>
                            ...
                            <?php $no=0; foreach($all as $row): $no++; ?>
                                <tr>
                                    <td><?php echo $no; ?></td>
                                    <td><?php echo $row->id_bidang_barang; ?></td>
                                    <td><?php echo $row->nama_bidang_barang; ?></td>
                                    <td><?php echo $this->M_bidang_barang->countSub($row->id_bidang_barang)->num_rows(); ?> Sub Bidang</td>
                                   <?php 
                                    if($row->status==1){
                                      $status= "<label class='label label-success'>Aktif</label>";
                                      $site=site_url('bidang/hapus/'.$row->id_bidang_barang);
                                      $class="btn-danger";
                                      $icon="remove-sign";
                                      $teks="Nonaktifkan";
                                    }else{
                                      $status= "<label class='label label-important'>Nonaktif</label>";
                                      $site=site_url('bidang/aktifkan/'.$row->id_bidang_barang);
                                      $class="btn-info";
                                      $icon="ok-sign";
                                      $teks="&nbsp;&nbsp;&nbsp;Aktifkan&nbsp;&nbsp;&nbsp;"; 
                                    }
                                  ...
                                  <td><?php echo $status; ?></td>
                                    <td>
                                      <center>
                                        <a href="<?php echo site_url('bidang/detail/'.$row->id_bidang_barang); ?>" class="btn btn-success"><i class="icon-zoom-in"></i> Detail</a>
                                        <a href="<?php echo site_url('bidang/edit/'.$row->id_bidang_barang); ?>" class="btn btn-warning"><i class="icon-edit"></i> Edit</a>
  ...
  <div id="myModal1" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-header">
        ...
        <h4 id="myModalLabel1">Tambah Bidang</h4>
    </div>
