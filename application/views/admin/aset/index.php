                        ...
                        <table class="table table-striped table-bordered" id="sample_1">
                            ...
                            <?php $no=0; foreach($all as $row): $no++;?>
                                <tr>
                                    ...
                                    <td><?php echo $this->M_aset->getCount($row->id_subbid_barang)->num_rows();?></td>
                                   <?php 
                                    if($row->status==1){
                                  ...
                                  <td><?php echo $status; ?></td>
                                    <td>
                                      <center>
                                        <a href="<?php echo site_url('Aset/detail/'.$row->id_subbid_barang);?>" data-toggle="modal" class="btn btn-success"><i class="icon-zoom-in"></i> Detail</a>
                                      </center>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
