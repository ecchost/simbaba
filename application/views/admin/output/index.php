          ...
          <div class="span12">
              ...
              <div class="widget red">
                  <div class="widget-title">
                      <h4><i class="icon-eye-open"></i> Output Barang</h4>
                  </div>
                  <div class="widget-body">
                     <table class="table table-striped table-bordered" id="sample_1">
                          ...
                          <tbody>
                          <?php 
                          $site=array('','Tanah','Peralatan_mesin','Gedung_bangunan','Irigasi','Aset','Konstruksi');
                          $no=0; foreach($all as $row): $no++;?>
                              <tr>
                                  <td><?php echo $no;?></td>
                                ...
                                <td><?php echo $status; ?></td>
                                  <td>
                                    <center>
                                      <a href="<?php echo $site[$no]; ?>" class="btn btn-success"><i class="icon-zoom-in"></i> Detail</a>
                                    </center>
                                  </td>
                              </tr>
                          <?php endforeach; ?>
