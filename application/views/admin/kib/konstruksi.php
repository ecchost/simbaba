...
header("Content-Disposition: attachment; filename=OutputKonstruksi.xls");
?>
...
<!-- <table border="0" style="font-size:15px;border:none;font-family:Arial;"> -->
  <tr>
    <td colspan="13"><center style="font-size:16px;">KARTU INVENTARIS BARANG(KIB) F<br>KONSTRUKSI</center></td>
    <td colspan="13"></td>
  </tr> 
<!--</table>-->
  <tr>
...
<table border="1" style="font-size:13px;border:100px;font-family:Arial;">
    ...
    <tr>
        ...
        <th rowspan="2" width="200"><center>Nilai<br>Kontrak</center></th>
        <th rowspan="2" width="200"><center>Ket</center></th>
    </tr>
    <tr>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>&nbsp;<?php echo uang($row->kontrak); ?></td>
