<div id="main-content">
                            ...
                            <?php $no=0; foreach($all as $row): $no++;?>
                                <tr>
                                  ...
                                  <td><?php echo $status; ?></td>
                                    <td>
                                      <center>
                                        <a href="<?php echo site_url('Merk/update/'.$row->id_merk); ?>" class="btn btn-warning"><i class="icon-edit"></i> Edit</a>
  ...
  <div id="myModal1" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-header">
        ...
        <h4 id="myModalLabel1">Tambah Merk</h4>
    </div>
    <form action="<?php echo site_url('Merk/add');?>" method="post">
    <div class="modal-body">
        <div class="control-group">
            <div class="row">
                ...
                <div class="span8">
                    <div class="controls">
                        <input type="text" required autocomplete="off" value="<?php echo $id?>" readonly class="span12" name="kode">
             ...
             <div class="row">
                 <label class="span1"></label>
                 <label class="span3">Nama Merk</label>
                <div class="span8">
                    <div class="controls">
